...
const Logincompany=()=>{
  let navigate = useNavigate();
    ...
    const handleEmailSubmit = () => {
      ...
      navigate(`/newpasswordcompany?email=${email}`);
    };
    ...
    <div class="col-12 col-md-1">
        ...
        <div class="col-12 col-md-5">
            ...
            <div class="loginheader">
                <h2 class="loginheader1">Login(company)</h2>
          ...
          value={password}/> 
           <i className="fa-solid fa-eye icon1" onClick={togglePasswordVisibility}></i>
            ...
            <a href="/companymblotp"  className="loginforgot"><h6 class="loginh4">Login via OTP</h6></a>
           <a href="./postajob" className="signgoogle"> <span class="logingoogle"><button class="loginbutton2 shadow p-2"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzVDA2e7vaSAfhljLBVppf2X0b0OuAxTQZqjYZcemxu6Umeik13cJI3HYISVRfEz9SMQA&usqp=CAU" alt="" class="googleimg"/>Sign in with Google</button></span></a>
