...
const fetchblogs= async ()=>{
  const api= "http://localhost:5010/alljobs";
  const authToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjoiNjRkNWQ3NGNhNmZmZDVkNWMyMjVkNmJiIiwiaWF0IjoxNjkxNzQ0NTI3LCJleHAiOjE3Mjc3NDQ1Mjd9.jkgWOgy8JfmY2upTDUaxtaEPvGLSFfCxkFMOY2TFDXk';
    try {
...
{/* ......... */}
          ...
          <div className='container'>
            ...
            <div className='col-md-2'>
                <p className='para616'>{selectedblog.companyname}  <button onClick={onclickblogdetails} className='cross'>✖</button></p>
   ...
   {blogslist.map((blog)=>
             ...
             <div className='container'onClick={((e)=>onclickblogdetails(blog._id))}>
                <div className='row'>
                <div className="col-12 col-md-3 mb-3">
                  <button className="buttonlocation card w-100"   >{blog.companyname}</button>
               </div>
               <div className="col-12 col-md-3 ">
                  <button className="buttonlocation card w-100">{blog.companyname}</button>
               </div>
